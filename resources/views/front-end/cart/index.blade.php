                ...
                @foreach($cart_products as $cart_product)
                    <div class="cart-single-list">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-1 col-md-2 col-12">
                                <a class="remove-item" href="{{route('cart.remove',['row_id'=>$cart_product->rowId])}}" onclick="return confirm('are you sure to delete this!!!');"><i class="lni lni-close"></i></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        <li>Tax Total(15%)<span>{{$tax = round($sum * 0.15)}}</span></li>
