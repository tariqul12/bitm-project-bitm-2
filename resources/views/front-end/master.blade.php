            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-3 col-7">
                    ...
                    <a class="navbar-brand" href="{{route('home')}}">
                        <img src="{{ asset('/') }}front-end-assets/assets/images/logo/logo.svg" alt="Logo">
                    </a>
                            ...
                            <div class="cart-items">
                                ...
                                <div class="shopping-item">
                                    ...
                                    <ul class="shopping-list">
                                        ...
                                        <li>
                                            <a href="{{route('cart.remove',['row_id'=>$cartItem->rowId])}}" class="remove" title="Remove this item"><i class="lni lni-close"></i></a>
                                            <div class="cart-img-head">
                                                <a class="cart-img" href="product-details.html"><img src="{{ asset($cartItem->options->image) }}" alt="#"></a>
                                            </div>
                                            <div class="content">
                                                <h4><a href="product-details.html">
                                                        {{$cartItem->name}}</a></h4>
                                                <p class="quantity">{{$cartItem->price}} x {{$cartItem->qty}} <span class="amount">{{$cartItem->subtotal}}</span></p>
                                            </div>
                                        </li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="{{ asset('/') }}front-end-assets/assets/images/logo/white-logo.svg" alt="#">
                            </a>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-12">
                        <div class="payment-gateway">
                            <span>We Accept:</span>
                            <img src="{{ asset('/') }}front-end-assets/assets/images/footer/credit-cards-footer.png" alt="#">
                        </div>
                    </div>
                    <div class="col-lg-4 col-12">
                        <div class="copyright">
