...
{{--                            />--}}
        ...
        @foreach($order->orderDetails as $orderDetail)
            <tr class="item">
                ...
                <td>{{$total = $orderDetail->product_qty * $orderDetail->product_price}}</td>
            </tr>
            @php
                $sum += $total
            @endphp
        ...
        <tr class="total">
            ...
            <td></td>
            <td align="center"></td>
            <td align="right">Shipping Cost:{{ $sipping = 100 }}Tk.</td>
        </tr>
        <tr class="total">
            <td></td>
            <td></td>
            <td align="center"></td>
            <td align="right">Total Payable:{{$sum + $tax + $sipping}} Tk.</td>
        </tr>
